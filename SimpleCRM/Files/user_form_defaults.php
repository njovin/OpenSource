<?php session_start(); $title = "Default Form Values";$safe_title="user_form_defaults"; $access_level = 1;?>
<?php include('inc/header.php');?>
<h2 class="text-center">List Values</h2>
<?php if(isset($_POST['update_the_values'])): 
	...
	$update = $user->update_default_form_values($_POST);
	if($update['status'])
...
<?php $form_fields = $user->get_default_form_fields(); ?>
